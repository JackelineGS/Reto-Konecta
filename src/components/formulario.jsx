import { Card, CardContent, Grid, TextField, Typography, Autocomplete, Paper, List, Radio, FormControlLabel, Button } from '@mui/material'
          ...
          >
            <List>
              ...
              > <div style={{
                ...
                <Typography sx={typoEncabezado}
                >
                  Datos personales
                </Typography>
                <Button sx={styleAñadir}>
                  Editar</Button>
                </div>
                <CardContent>
                  <form>
                ...
                <CardContent>
                  <Accordion>
                    ...
                    style={{
                      ...
                      <FormControlLabel value="female" control={<Radio />} label="Con experiencia" sx={typoExperiencia} />
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography>
                ...
                <CardContent>
                  <Accordion
                      style={{
                        ...
                        <FormControlLabel value="female" control={<Radio />} label="Sin experiencia" sx={typoExperiencia} />
                      </Accordion>
                </CardContent>
              </Card>
              <Card
                ...
                <CardContent>
                  ...
                  <Accordion
                    ...
                    <Accordion
                      ...
                      <Typography sx={typoLetra} >CURSOS /ESPECIALIZACIONES</Typography>
                      <Button sx={styleAñadir}>Añadir</Button>
                      </div>
                      </Accordion>
