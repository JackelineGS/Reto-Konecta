...
export default function ListaPostulantes() {
  ...
  async function sendWelcomeNotification() {
    const host =
      "https://iezopofihj.execute-api.us-east-1.amazonaws.com/dev/notifications/welcomeSin";
  ...
  async function sendWelcomeNotificationrRecontacto() {
    const host =
      "https://iezopofihj.execute-api.us-east-1.amazonaws.com/dev/notifications/reminder";
  ...
  async function sendPostRequest() {
    const hostHackLab =
      "https://iezopofihj.execute-api.us-east-1.amazonaws.com/dev/notifications/status";
    const requestData = {
      recipientPhoneNumber: "+51925474137",
      user: "Carlos",
    };
  ...
  const handleStatusChange = (event, id) => {
    ...
    } else if (newStatus === "recontacto") sendWelcomeNotificationrRecontacto();
    else if (newStatus === "no apto") sendPostRequest();
        ...
        >
          ...
          <TableHead>
            <TableRow style={{ backgroundColor: "#B2B4B2" }}>
              ...
              <TableCell style={{ fontWeight: "bold" }}>Postulación</TableCell>
              <TableCell style={{ fontWeight: "bold" }}>
                IGC de postulación
              </TableCell>
              <TableCell style={{ fontWeight: "bold" }}>
              ...
              <TableCell style={{ fontWeight: "bold" }}>Resultado</TableCell>
              ...
              <TableRow key={row.id}>
                ...
                <TableCell>
                  ...
                  >
                    ...
                    <MenuItem value='confirmado capa'>
                      Confirmado a capacitación
                    </MenuItem>
